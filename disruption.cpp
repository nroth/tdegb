...
double Disruption::Main_Sequence_Radius(double mstar)
{
...
double Disruption::Hills_Mass(double mstar)
{
...
double Disruption::Peak_Mdot(double mstar)
{
...
double Disruption::Max_Luminosity(double mstar)
{
