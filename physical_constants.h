...
#define K_BOLTZ_EV      8.6173324e-5        // boltz const in eV/K
#define H_PLANCK        6.6260755e-27   // plancks constant (h) in ergs-s
#define STEF_BOLTZ      5.6704e-5         // stefan-boltz (sigma) erg cm-2 s-1 K-4
...
#define NEWTON_G        6.67384e-8         // graviational const gm-1 cm3 s-2
#define THOMSON_CS      0.66523e-24       // Thomson cross-section cm-2
...
#define SIGMA_TOT       0.0265400193567 // integrated line coefficent (cm^2 Hz) 

// astronomical constants
#define M_SUN           1.98847e33      // solar mass in grams
#define R_SUN           6.957e10        // solar radius in cm
#define L_SUN           3.828e33        // solar luminosity in  erg s-1
...
#define YEAR_TO_SEC    3.1559626e7
